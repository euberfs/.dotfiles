...
links=(
	...
	"$HOME/.dotfiles/dots_home/.bash_aliases $HOME/.bash_aliases"
	"$HOME/.dotfiles/dots_home/.bashrc $HOME/.bashrc"
	"$HOME/.dotfiles/dots_home/.profile $HOME/.profile"
	"$HOME/.dotfiles/dots_home/.tmux.conf $HOME/.tmux.conf"
	"$HOME/.dotfiles/dots_home/.xinitrc $HOME/.xinitrc"
